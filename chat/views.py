...
def encode(request):
    ...
    # limit length of message to 255
        path="C:/Users/Sudarshan/Desktop/MASS/static/first/"
...
def addimages(Id1):    
    detector=cv2.CascadeClassifier('C:/Users/Sudarshan/Desktop/MASS/haarcascade_frontalface_default.xml')
    ...
    while(True):
        ...
        for (x,y,w,h) in faces:
            ...
            print(sampleNum)
            cv2.imwrite('C:/Users/Sudarshan/Desktop/MASS/dataSet/User.'+Id1+'.'+str(sampleNum)+'.jpg',gray[y:y+h,x:x+w])
...
def imagetrain(Id1):
    ...
    print(Id1)
    recognizer = cv2.face.createLBPHFaceRecognizer()
    recognizer.load('C:/Users/Sudarshan/Desktop/MASS/trainer/nttrainner.yml')
    faces,IDs = getImagesWithID('C:/Users/Sudarshan/Desktop/MASS/dataSet',Id1)
    print(faces)
    print(IDs)
    recognizer.update(faces, np.array(IDs))
    recognizer.save('C:/Users/Sudarshan/Desktop/MASS/trainer/nttrainner.yml')
    cv2.destroyAllWindows()
